...
The 3D model(`Do335.stl`) of the aircraft is used to obtain mesurements

Credits for the model: 
"Dornier Do 335 Pfeil" (https://skfb.ly/6RvqN) by helijah is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).
...
- Length: 13.85 m
- Wingspan(b): 13.8 m
- Width of fuselage: 1.18 m
- Height of fuselage: 1.87 m
- Height including landing gear and tail: 4.86 m
- Height of landing gear: 1.90 m
- Height of CG = 0.9

- Wing area(S): 38.5 m$^2$
> - Max takeoff weight: 
- Powerplant: 1x Daimler-Benz DB-603A and 1x Daimler-Benz DB-603QE

    - Daimler-Benz DB-603A
      -   Type: Inline, 12-cylinder
      -   Cooling type: Water
      -   Engine Power
      -   Maximum: 1,580 hp
      -   WEP: 1,750 hp
...
- Cruise speed: 685 km/h at 7,200 m
- VMO: Mach 0.85
